                ...
                <div className='header-menu '>
                    <div className='header-element'>
                        ...
                        <div className="header-switcher" onClick={toggleTheme}>
                            <div className={`switch-dot light ${isDark ? 'border border-white' : 'border border-dark'}`}></div>
                            <div className={`switch-dot dark ${isDark ? 'border border-white' : 'border border-dark'}`}></div>
                        </div>
                        <div className="header-languages">
                            <div className="langswitcher">
                                <a className="lang-link active" lang="fr-FR" hrefLang="fr-FR" href="#" data-taxi-ignore="">fr</a>
                                <a className="lang-link" lang="en-GB" hrefLang="en-GB" href="#" data-taxi-ignore="">en</a>
                            </div>
                        </div>
                    </div>
                    <div className="header-toggler">
                        <div className="toggler-label" onClick={toggleMenu}>
                            <span className={`label-menu`} >{isOpen ? 'Close' : 'Menu'}</span>
                ...
                <div className='header-menu-wrapper position-fixed top-header pt-3 left-0 align-items-start w-100 grid-w uppercase pointer-events-none overflow-hidden' style={{visibility:`${isOpen ? 'visible' : 'hidden'}`, opacity:`${isOpen ? '1' : '0'}`}}>
                    ...
                    <div className='header-item-col  d-flex flex-column justify-between pointer-events-auto transition-mode'>
                        <div className='d-flex flex-column'>
                         ...
                         <a href="#" className='link header-item -mt-px hidden d-md-flex align-items-md-end  transition-mode'>
                            <span className='words chars splitting'>
                                <span className='word'>Abouts</span>
                            </span>
                        </a>
                    </div>
                    <div className='header-item-col  d-flex flex-column justify-between pointer-events-auto transition-mode'>
